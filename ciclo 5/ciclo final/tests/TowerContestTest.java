...
public class TowerContestTest {
    ...
    @Test
    public void shouldParseCupNumbersFromSampleCase() {
        assertArrayEquals(new int[]{4, 2, 3, 1}, TowerContest.parseCupNumbers("7 3 5 1"));
    }

    @Test
    public void shouldParseSingleCupNumber() {
        assertArrayEquals(new int[]{1}, TowerContest.parseCupNumbers("1"));
    }

    @Test
    public void shouldParseMultipleCupNumbers() {
        assertArrayEquals(new int[]{3, 1, 2}, TowerContest.parseCupNumbers("5 1 3"));
    }
}
